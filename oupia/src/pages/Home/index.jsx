...
const Home = () => {
    ...
    return (
        <>
            <section className="bg-center h-screen bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/dLinkocs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply pt-10">
